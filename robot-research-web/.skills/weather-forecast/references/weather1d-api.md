...
| Endpoint | `GET https://app-csctj2dvhmo1-api-Aa2PZnjEVgyL-gateway.appmiaoda.com/lundear/weather1d` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | 无请求体（GET 请求，参数通过 Query String 传递） |
| Third-Part Domain | `app-csctj2dvhmo1-api-Aa2PZnjEVgyL-gateway.appmiaoda.com` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游接口 ---
  const upstreamUrl = new URL("https://app-csctj2dvhmo1-api-Aa2PZnjEVgyL-gateway.appmiaoda.com/lundear/weather1d");
