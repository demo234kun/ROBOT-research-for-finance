...
| Endpoint | `POST https://app-csctj2dvhmo1-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-csctj2dvhmo1-api-baBw2m51JXz9-gateway.appmiaoda.com` |
...
async function queryCaipiaoResult(
  ...
  const url =
    `https://app-csctj2dvhmo1-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query?${params.toString()}`;
