...
| Endpoint | `POST https://app-csctj2dvhmo1-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-csctj2dvhmo1-api-qYGW2z745vzY-gateway.appmiaoda.com` |
...
async function queryCaipiaoHistory(
  ...
  const url =
    `https://app-csctj2dvhmo1-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history?${params.toString()}`;
