...
- **Endpoint**: `GET https://app-csctj2dvhmo1-api-qYGWoqjEmMnY-gateway.appmiaoda.com/v2/tools/trending_lists/medium`
...
async function queryTrendingList(type: number): Promise<TrendingItem[]> {
  const url = new URL(
    "https://app-csctj2dvhmo1-api-qYGWoqjEmMnY-gateway.appmiaoda.com/v2/tools/trending_lists/medium"
  );
