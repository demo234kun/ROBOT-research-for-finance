...
| Endpoint | `POST http://app-csctj2dvhmo1-api-baBw3XMNVmv9-gateway.appmiaoda.com/v1/images/edits` |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "http://app-csctj2dvhmo1-api-baBw3XMNVmv9-gateway.appmiaoda.com/v1/images/edits",
    {
      method: "POST",
      headers: {
