...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 城市限行查询 | POST | `https://app-csctj2dvhmo1-api-pLVzAxRQyMWL-gateway.appmiaoda.com/vehiclelimit/query` |
| 获取支持限行查询的城市列表 | POST | `https://app-csctj2dvhmo1-api-DYJwnJVBwb4a-gateway.appmiaoda.com/vehiclelimit/city` |
